...
DOCUMENTATION = """
---
module: endpoint_ztna_tags
short_description: ZTNA Tag Resource
description:
  - ZTNA Tag Resource.
...
def main():
    url = "/resource-api/v2/endpoint/ztna-tags"
    src_arg_spec = {
        ...
        "params": {
            "type": "dict",
            "required": True,
            "options": {"primaryKey": {"type": "str", "required": True, "no_log": False}, "name": {"type": "str"}}
        }
    }
