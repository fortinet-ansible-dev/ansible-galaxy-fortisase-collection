...
short_description: Endpoint Policy Resource
description:
    ...
    params:
        ...
        suboptions:
            ...
            enabled:
                type: bool
                description: no description
            skipOffNetProfileCreationOnEdit:
                type: bool
                description: no description
"""
...
def main():
    url = "/resource-api/v2/endpoint/policies"
    src_arg_spec = {
        ...
        "params": {
            ...
            "options": {
                ...
                "enabled": {"type": "bool"},
                "skipOffNetProfileCreationOnEdit": {"type": "bool"}
            }
        }
    }
