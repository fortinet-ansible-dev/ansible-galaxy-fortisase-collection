...
DOCUMENTATION = """
---
module: security_schedule_groups
short_description: Schedule Group Resource
description:
...
def main():
    url = "/resource-api/v2/security/schedule-groups"
    src_arg_spec = {
            ...
            "options": {
                ...
                "members": {
                    ...
                    "options": {
                        ...
                        "datasource": {"type": "str", "choices": ["security/onetime-schedules", "security/recurring-schedules"]}
                    }
                }
            }
        }
