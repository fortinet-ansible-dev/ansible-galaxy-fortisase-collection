...
DOCUMENTATION = """
---
module: endpoint_group_ad_user_profiles
short_description: Group & AD Users Profile Resource
description:
...
def main():
    url = "/resource-api/v2/endpoint/group-ad-user-profiles/{primaryKey}"
    src_arg_spec = {
        ...
        "params": {
            ...
            "options": {
                ...
                "adUserIds": {"type": "list", "elements": "int"},
                "groupIds": {"type": "list", "elements": "int"}
            }
        }
    }
