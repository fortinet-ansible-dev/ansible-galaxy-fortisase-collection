...
DOCUMENTATION = """
---
module: security_internal_policies
short_description: Internal Policy Resource
description:
...
def main():
    url = "/resource-api/v2/security/internal-policies"
    src_arg_spec = {
            ...
            "options": {
                ...
                "users": {
                    ...
                    "options": {
                        ...
                        "datasource": {"type": "str", "choices": ["auth/user-groups", "auth/users"]}
                    }
                },
                "destinations": {
                    "type": "list",
