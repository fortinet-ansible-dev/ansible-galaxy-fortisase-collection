...
DOCUMENTATION = """
---
module: security_video_filter_youtube_key
short_description: Video Filter Youtube API Key Resource
description:
...
def main():
    url = "/resource-api/v2/security/video-filter-youtube-key"
    src_arg_spec = {
        ...
        "params": {
            "type": "dict",
            "required": True,
            "options": {"primaryKey": {"type": "str", "required": True, "no_log": False}, "apiKey": {"type": "str", "no_log": True}}
        }
    }
