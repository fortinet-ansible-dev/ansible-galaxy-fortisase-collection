...
DOCUMENTATION = """
---
module: security_outbound_policies
short_description: Outbound Policy Resource
description:
...
def main():
    url = "/resource-api/v2/security/outbound-policies"
    src_arg_spec = {
            ...
            "options": {
                ...
                "destinations": {
                    ...
                    "options": {
                        ...
                        "datasource": {
                            "type": "str",
                            "choices": ["network/host-groups", "network/hosts", "network/internet-services", "security/ip-threat-feeds"]
                        }
                    }
                },
                "services": {
                ...
                "sources": {
                    ...
                    "options": {
                        ...
                        "datasource": {
                            "type": "str",
                            "choices": [
                                "endpoint/ztna-tags", "infra/extenders", "infra/fortigates", "infra/ssids", "network/host-groups", "network/hosts",
                                "security/ip-threat-feeds"
                            ]
                        }
                    }
                },
                "captivePortalExempt": {"type": "bool"}
            }
        }
    }
