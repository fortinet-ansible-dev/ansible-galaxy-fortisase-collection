...
DOCUMENTATION = """
---
module: security_ssl_ssh_profile
short_description: SSL Inspection Profile Resource
description:
            ...
            caCertificate:
                ...
                suboptions:
                    ...
                    datasource:
                        type: str
                        description: no description
            expiredCertificateAction:
                type: str
                description: no description
                choices:
                    - "allow"
                    - "block"
            revokedCertificateAction:
                type: str
                description: no description
                choices:
                    - "allow"
                    - "block"
            timedOutValidationCertificateAction:
                type: str
                description: no description
                choices:
                    - "allow"
                    - "block"
            validationFailedCertificateAction:
                type: str
                description: no description
                choices:
                    - "allow"
            ...
            urlCategoryExemptions:
                ...
                suboptions:
                    ...
                    datasource:
                        ...
                        description: no description
                        choices:
                            - "security/fortiguard-categories"
                            - "security/fortiguard-local-categories"
"""
...
def main():
    url = "/resource-api/v2/security/ssl-ssh-profile/{direction}/{primaryKey}"
    src_arg_spec = {
        ...
        "params": {
            ...
            "options": {
                ...
                "inspectionMode": {"type": "str", "choices": ["certificate-inspection", "deep-inspection", "no-inspection"]},
                "profileProtocolOptions": {
                    "type": "dict",
                    "options": {
                        "unknownContentEncoding": {"type": "str", "choices": ["block", "bypass", "inspect"]},
                        "oversizedAction": {"type": "str", "choices": ["allow", "block"]},
                        "compressedLimit": {"type": "int"},
                        "uncompressedLimit": {"type": "int"}
                    }
                },
                "caCertificate": {
                    "type": "dict",
                ...
                "expiredCertificateAction": {"type": "str", "choices": ["allow", "block"]},
                "revokedCertificateAction": {"type": "str", "choices": ["allow", "block"]},
                "timedOutValidationCertificateAction": {"type": "str", "choices": ["allow", "block"]},
                "validationFailedCertificateAction": {"type": "str", "choices": ["allow", "block"]},
                "certProbeFailure": {"type": "str", "choices": ["allow", "block"]},
                "quic": {"type": "str", "choices": ["block", "bypass", "inspect"]},
                "hostExemptions": {
                    "type": "list",
                    "elements": "dict",
                    "options": {
                ...
                "urlCategoryExemptions": {
                    ...
                    "options": {
                        "primaryKey": {"type": "str", "no_log": False},
                        "datasource": {"type": "str", "choices": ["security/fortiguard-categories", "security/fortiguard-local-categories"]}
                    }
                }
            }
        }
